...
export const apiSlice = createApi({
  ...
  tagTypes: ['Board', 'List', 'Card', 'Workspace', 'User', 'WorkspaceMember', 'Activity', 'Notification', 'Comment', 'NotificationPreferences', 'Template', 'AiConversation', 'Suggestion', 'OKR', 'DependencyGraph', 'Workload', 'Focus'],
  endpoints: () => ({}),
});
